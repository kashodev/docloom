"""`docsynth studio` — an interactive/scriptable orchestrator over the CLI.
...
no generation machinery — every step shells into the existing ``docsynth`` CLI.
...
from docsynth.studio.targets import available_targets, get_target
