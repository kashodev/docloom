...
This is the reference implementation of :class:`~docsynth.core.pack.DocumentPack`;
...
from docsynth.core.content import ContentCapability, ContentMode
...
from docsynth.packs.invoice.catalog import (
    BusinessSpec,
    Catalogue,
    Company,
    CompanyRoster,
...
from docsynth.packs.invoice.context import (
    body_classes,
    build_context,
    column_headers,
    group_line_items,
)
from docsynth.packs.invoice.enums import (
    BillingModel,
    BusinessType,
    CodeSystem,
    DiscountScheme,
...
from docsynth.packs.invoice.jurisdictions import (
    PROFILES,
    US_STATE_SALES_TAX,
    JurisdictionProfile,
    TaxRule,
...
from docsynth.packs.invoice.labels import LABEL_REGISTRY
from docsynth.packs.invoice.record import (
    GoldenInvoice,
    InvoiceTotals,
    LineItem,
    Party,
...
from docsynth.packs.invoice.catalog import HANDWRITTEN_ARCHETYPE  # noqa: E402
...
class InvoicePack:
    ...
    def default_source(
        ...
        *,
        ...
        `pip install docsynth` runnable end to end. Point it at a published
        ...
        if catalogue:
            from docsynth.packs.invoice.artifact import load_catalogue
