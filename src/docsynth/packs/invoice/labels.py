...
from docsynth.core.locale.enums import Language
...
LABELS: dict[Language, dict[str, str]] = {
    ...
    Language.EN: {
        ...
        "goods_received_note": "Goods received in good condition.",
    ...
    Language.FR_CA: {
        ...
        "print_name": "Nom en lettres moulées",
        "date_received": "Date de réception",
        "goods_received_note": "Marchandises reçues en bon état.",
