...
:class:`~docsynth.core.providers.mix.ProviderMix`, generated within a hard dollar
:class:`~docsynth.core.providers.budget.BudgetGuard`. Two things make it more than
a for-loop:
...
from docsynth.core.providers.base import CompletionRequest, CompletionResult, TextProvider
from docsynth.core.providers.budget import BudgetExceeded, BudgetGuard
from docsynth.core.providers.mix import PROCEDURAL, ProviderMix
from docsynth.core.usage.base import LlmUsage, UsageSink
