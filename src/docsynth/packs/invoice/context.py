...
from docsynth.core.fonts import font_face_css, font_stack
...
from docsynth.packs.invoice.logos import logo_mark, watermark_mark
from docsynth.packs.invoice.record import GoldenInvoice, LineItem
