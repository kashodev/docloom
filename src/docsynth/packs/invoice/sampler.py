...
from docsynth.core.pipeline.source import stable_seed
...
from docsynth.packs.invoice.composition import Composition, resolve
...
from docsynth.packs.invoice.jurisdictions import profile_for
...
def _rate_text(rate: Decimal, language) -> str:
    from docsynth.core.locale.enums import Locale
    from docsynth.core.locale.formatting import format_rate
