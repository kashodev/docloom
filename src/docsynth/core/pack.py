...
from docsynth.core.content import ContentCapability
...
if TYPE_CHECKING:
    ...
    # checking.
    from docsynth.core.pipeline.source import DocumentSource
...
class DocumentPack(Protocol):
    ...
    def content_capability(self) -> ContentCapability:
        """Where this pack's content comes from — see :mod:`docsynth.core.content`.
        ...
        :func:`~docsynth.core.content.capability_of`, which defaults to procedural
    ...
    def default_source(
        ...
        *,
        ...
        :class:`~docsynth.core.selection.UnsupportedConstraint` for what it
