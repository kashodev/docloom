...
from docsynth.packs.invoice.validation import check_text
...
async def build_llm_catalogue(
    ...
    *,
    ...
    :func:`~docsynth.packs.invoice.procedural.generate_catalogue`, so it drops
    straight into :func:`~docsynth.packs.invoice.artifact.write_catalogue`, plus a
