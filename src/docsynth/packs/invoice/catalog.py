...
* :class:`SeedCatalogue` — procedural, built in, **no API keys**. Produces valid,
  varied invoices with modest lexical diversity. This is what makes docsynth run
...
from docsynth.core.fonts import TYPEFACE_KEYS
...
from docsynth.packs.invoice.record import Party, RenderProfile, TaxRegistration
...
class SeedCatalogue:
    ...
    def version(self) -> str:
        ...
        docsynth does. An artifact catalogue returns its own published version."""
